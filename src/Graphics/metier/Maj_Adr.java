...
public class Maj_Adr extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Reste dû pour la location");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        int fkloc = locat.getSelectedIndex();
        Location l = loc.get(fkloc);
        Double reste =l.getTotal()-l.getAcompte();
        JOptionPane.showMessageDialog(this, "Le reste à payer pour cette location est :"+reste, "Succès", JOptionPane.INFORMATION_MESSAGE);
